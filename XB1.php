...
<html>
    <head>
     ...
     <style>
         body{
            text-align:center;
            background-image:url("/final_projects/images/Xbox-one-background.jpg");
    ...
    <?php
        ...
        foreach($games as $game){
          ...
          echo "<tr><td><img src = '". $game['image']. "' height = '150' width = '150'/></td><td>".$game['name'] . "</td><td>". $game['price'] ."</td><td>".
           "<a href='XB1.php?addToCart= ".$game['name']."&nbsp&nbsp $" .$game['price']."'><button " . gamesInCart($game['name'])."type=\"button\" class=\"btn btn-default btn-sm\">
        ...
        foreach($systems as $system){
          ...
          echo "<tr><td><img src = '". $system['fotos']. "' height = '150' width = '150'/></td><td>".$system['Console_Name'] . "</td><td>". $system['precio'] ."</td><td>".
           "<a href='XB1.php?addToCart= ".$system['Console_Name']."&nbsp&nbsp $" .$system['precio']."'><button " . gamesInCart($system['Console_Name'])."type=\"button\" class=\"btn btn-default btn-sm\">
                         <span class=\"glyphicon glyphicon-shopping-cart\" aria-hidden=\"true\"></span> add to cart
                         </button></a>" . "</td></tr>";
